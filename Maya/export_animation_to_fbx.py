...
def export_fbx(export_path, file_name):
    ...
    # Set some FBX options via MEL
    mel.eval('FBXExportAnimationOnly -v true;')  # Export animations only
    mel.eval('FBXExportBakeComplexAnimation -v true;')  # Bake animations
    
    # Export the selected objects
    pc.system.exportSelected(export_path, type="FBX export")
    print(f"Animation exported as FBX to {export_path}")
